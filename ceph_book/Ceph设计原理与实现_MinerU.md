...
> [💡 **阅读笔记：Ceph 的两级映射机制 (对象 -> PG -> OSD)**](./notes/01_Ceph两级映射机制_对象_PG_OSD_解析.md)  
...
> [💡 **阅读笔记：Straw 算法核心疑问解答**](./notes/02_Straw算法原理与OSD选择机制解析.md)  
> 疑问：e1/e2 是指代磁盘吗？签长最大者即被选中？

> [💡 **阅读笔记：映射过程与数据拷贝的关系**](./notes/03_Straw算法数据映射与物理拷贝关系解析.md)  
> 疑问：数据映射是算出来的还是考贝出来的？
...
> [💡 **阅读笔记：Select 参数解读与最终 OSD 定位机制**](./notes/04_Select操作参数与递归下降定位机制解析.md)  
...
> [💡 **阅读笔记：CRUSH reweight 过载测试机制**](./notes/05_CRUSH_Reweight机制与实际应用解析.md)  
...
> [💡 **阅读笔记：CRUSH 参数模板 Profile 内容与源码实现**](./notes/06_CRUSH可调参数模板Profile与源码实现解析.md)  
...
> [💡 **阅读笔记：crushtool 中 root 层 size=0 的含义与源码**](./notes/07_crushtool_build根节点size=0含义与源码解析.md)  
...
> [💡 **阅读笔记：crushtool 模拟测试参数与结果解析**](./notes/08_crushtool模拟测试参数与结果解析.md)  
...
> [💡 **阅读笔记：Reweight 触发数据迁移的原理与源码**](./notes/09_Reweight调整触发数据迁移机制与源码解析.md)  
...
> [💡 **阅读笔记：COW "不能释放原有块" 机制解析与权衡**](./notes/10_COW不完全覆盖写与空间换时间权衡解析.md)  
...
> [💡 **阅读笔记：BlueStore 元数据转 KV 存储与索引机制**](./notes/11_BlueStore元数据KV存储与索引机制解析.md)  
...
> [💡 **阅读笔记：客户端如何定位并选择目标 OSD**](./notes/12_客户端OSD定位与OSDMap更新机制解析.md)  
...
> [💡 **阅读笔记：PG 分裂机制、倍增原理与实践建议**](./notes/13_PG分裂机制详解与实践指南.md)  
...
> [💡 **阅读笔记：压缩后 Extent 的不完全覆盖写方案解析**](./notes/14_压缩Extent不完全覆盖写方案解析.md)  
...
> [💡 **阅读笔记：Blob 与 Extent 的关系及源码对应**](./notes/15_Blob与Extent关系及源码对照解析.md)  
...
> [💡 **阅读笔记：Blob 被相邻 Extent 共享及分片问题**](./notes/16_Blob跨分片共享与spanning_blob机制解析.md)  
...
> [💡 **阅读笔记：extent map 代码定义与表 2-10 的对应关系**](./notes/17_ExtentMap代码定义与表2_10对照解析.md)  
...
> [💡 **阅读笔记：BlueStore 对象相关数据结构体总结**](./notes/18_BlueStore对象数据结构体关系总结.md)  
...
# 2.3.2 BlueStore中的缓存管理 [📝 缓存结构体源码对照](./notes/19_BlueStore缓存管理结构体源码对照.md)
...
[📝 PG实体与Collection源码解析](./notes/20_PG实体与Collection源码解析.md)
...
# 2.4.3 BitmapAllocator [📝 BitmapAllocator 位图与树状结构解析](./notes/21_BitmapAllocator位图与树状结构解析.md)
...
# 2.5 BlueFS [📝 BlueStore 架构与组件关系解析](./notes/22_BlueStore架构与组件关系解析.md)
...
# 2.5.2 磁盘数据结构 [📝 BlueFS 日志机制与日志压缩解析](./notes/23_BlueFS日志机制与日志压缩解析.md)
...
[📝 BlueFS 日志机制与日志压缩解析](./notes/23_BlueFS日志机制与日志压缩解析.md)
...
[📝 2.6 BlueStore 与 BlueFS 生命周期及 IO 调用机制解析](./notes/24_BlueStore与BlueFS生命周期及IO调用机制解析.md)
...
[📝 Read 流程中 Collection 缺失与 -ENOENT 机制解析](./notes/25_Read流程中Collection缺失与ENOENT机制解析.md)
...
[📝 BlueStore 写回调 on_commit 与 on_readable 执行顺序机制解析](./notes/26_BlueStore写回调on_commit与on_readable执行顺序机制解析.md)
...
> [💡 **阅读笔记：BlueStore 覆盖写机制详解**](./notes/27_BlueStore覆盖写机制详解.md)  
...
> [📖 **章节总结笔记：第2章 BlueStore 核心机制总结与在 Ceph 存储体系中的作用**](./notes/28_第2章BlueStore核心机制总结与Ceph存储中的作用.md)  
...
# 3.3 纠删码在Ceph中的应用 [📝 纠删码生效原理与分片机制](./notes/29_第3章纠删码在Ceph中的生效原理.md)
...
# 表 4-1 常用术语 [📝 Up Set与Acting Set辨析](./notes/30_表4-1核心概念解析.md)
...
> [📝 31 RBD本质与Ceph架构路径对比](./notes/31_RBD本质与Ceph架构路径对比.md)
> [📝 32 第四章疑问解析与术语辨析](./notes/32_第四章疑问解析与术语辨析.md)
...
[深度解析：Op请求流转与OSD内部队列机制](notes/33_Op请求流转与OSD内部队列.md)
...
[深度解析：快照与 COW 机制——为什么产生新快照后必须克隆](notes/37_快照与COW机制详解.md)
...
[深度解析：PG 状态机与 MInfoRec 事件](notes/39_PG状态机与MInfoRec事件解析.md)
...
[深度解析：PG 内部状态机与外部状态的源码映射](notes/40_PG内部状态机与外部状态源码映射.md)
...
[深度解析：up_thru 机制详解与防死锁原理](notes/44_up_thru机制详解与防死锁原理.md)
...
# 4. GetMissing
> [[Notes 详解]](notes/49_GetMissing机制_权威日志与分歧日志的关系解析.md): Missing列表不是简单的对象清单，而是“对象->任务”的映射（Task Map）。记录每个特定对象需要执行的具体操作（拉取或覆盖）以达到预期状态。权威日志定义了标准，分歧日志是证据，Missing列表是指令。
...
典型如表4-18和表4-19所示的例子，此时仅包含一条分歧日志，其版本号为 10‘6，更新的日志条目（来自权威日志）版本号为 11‘6，两者操作同一个对象foo。为了防止两者执行完全不同的操作（例如一个改写foo的内容，另一个改写foo的omap)，此时直接将本地对象删除，将其加入missing列表，同时设置其need为 11‘6 ，have为0（即本地没有）。
...
*   [**53_PriorityQueue流程.md**](notes/53_PriorityQueue流程.md)

# 5.3.2 权重的优先级队列（wpq）

*   [**54_WPQ流程解析.md**](notes/54_WPQ流程解析.md)
...
- [**👉 8.3.2：MDS负载均衡机制解析 (Note 63)**](./notes/63_8.3.2_目录分片机制与源码解析.md)
...
- [**👉 8.3.3：MDS故障恢复机制解析 (Note 64)**](./notes/64_8.3.3_MDS故障恢复与源码解析.md)
